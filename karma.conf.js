module.exports = function (config) {
  ...
  config.set({
    files : [
      ...
      {pattern: 'out/libs/sortable.min.js', served: true, included: false, watched: false},
      {pattern: 'out/libs/angular-chart.min.js', served: true, included: false, watched: false},
      {pattern: 'out/libs/Chart.min.js', served: true, included: false, watched: false},
      {pattern: 'out/libs/angular-animate.min.js', served: true, included: false, watched: false},
      {pattern: 'out/libs/ui-bootstrap.min.js', served: true, included: false, watched: false},
      {pattern: 'out/libs/ui-bootstrap-tpls.min.js', served: true, included: false, watched: false},
      {pattern: 'out/libs/socket.js', served: true, included: false, watched: false},
